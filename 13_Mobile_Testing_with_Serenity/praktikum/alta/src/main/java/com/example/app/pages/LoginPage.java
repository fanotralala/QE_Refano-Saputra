...
public class LoginPage extends BasePageObject {
    ...
    private By loginBtn = By.xpath("com.loginmodule.learning:id/appCompatButtonLogin");

    private By emailField = By.xpath("com.loginmodule.learning:id/textInputEditTextEmail");

    private By passwordField = By.xpath("com.loginmodule.learning:id/textInputEditTextPassword");
